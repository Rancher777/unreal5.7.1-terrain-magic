...
public:
	...
	// World Partition support: Initialize with a specific landscape chunk
	void InitializeForLandscape(ALandscape* Landscape);
	...
	// World Partition support: Find landscape chunk containing a world location
	ALandscape* FindLandscapeAtLocation(const FVector& WorldLocation);
	
	// World Partition support: Get all landscape chunks in the world
	TArray<ALandscape*> GetAllLandscapeChunks() const;
	void ClipsAreDirty();
	...
	// World Partition support: Cache of all landscape chunks in the world
	UPROPERTY()
	TArray<ALandscape*> LandscapeChunks;
